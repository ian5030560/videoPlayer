...
public class SizeAnimation extends AnimationHub<Dimension>{
	...
	public SizeAnimation(JComponent comp, long duration) {
		this(comp);
	...
	@Override
	public void setValue(Dimension value1, Dimension value2) {
		this.timeline.addPropertyToInterpolate("size", value1, value2);
